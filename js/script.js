$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    if (currentScrollPos > 50) {
      ...
      $(".header-top .button-hover2").addClass("black-bg-btn");
      ...
      $(".header-top .button-hover2").removeClass("black-bg-btn");
  ...
  var contactsAnimation = function () {
    ...
    if ($(".develop-iceberg__item").length) {
      document
        .querySelectorAll(
          ".develop-iceberg__item:not(.develop-iceberg__item--top)"
        )
        .forEach(function (el) {
          tl2 = gsap.to(el, {
            scrollTrigger: {
    ...
    if ($(".develop-iceberg__base").length) {
      ...
      ScrollTrigger.matchMedia({
        ...
        "(max-width: 767px)": function () {
          tl && tl.kill(),
            tl2 && tl2.kill(),
            $(".develop-iceberg__item").removeAttr("style");
        },
      });
    }
  };
